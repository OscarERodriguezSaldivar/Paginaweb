...
<html>
        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
              ...
              <li><a href="Perfil.php" class="nav-link px-2 text-secondary">Perfil</a></li>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <section class="seccion-perfil-usuario">
        ...
        <div class="perfil-usuario-body">
            <div class="perfil-usuario-bio">
                 <h3><input class="titulo-input" id="user-name" name="user-name" value="<?php echo $_SESSION['user-name']; ?>"></h3>
            </div>
    ...
    <footer class="main-footer">
        <div class="footer__section">
            <h2 class="footer__title">Conócenos</h2>
            <p class="footer__txt">blah blah </p>
        </div>
        <div class="footer__section">
            <h2 class= "footer__title">Métodos de Pago</h2>
            <p class="footer__txt">blah blah </p>
        </div>
        <div class="footer__section">
        ...
        <div class="footer__section">
            <h2 class="footer__title">Suscríbete</h2>
            <p class="footer__txt">Regístrate para recibir las últimas ofertas en tu correo electrónico y comprar productos.</p>
