    ...
    <body>
        ...
        <main class="main">
            <section class="py-5 text-center container">
                <h1 class="fw-light">Productos de la lista</h1>
            ...
            <div class="album py-5 bg-light">
              ...
              if (isset($_GET['id'])) {
                ...
                $sql = "SELECT * FROM productosLista WHERE Id_ListaMadre = $ID_Lista";
                ...
                if ($result->num_rows > 0) {
                  ...
                  while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<p class='product__price'>$ $precio</p>";
                      
                      // Botones para ver el producto y eliminarlo (agregar los enlaces o acciones que correspondan)
                      echo '<div class="d-flex justify-content-between align-items-center">';
                      echo '<div class="btn-group">';
                      echo '<a type="button" class="btn btn-sm btn-outline-secondary" href="Producto.php?id=' . $row['Id_Producto'] . '">Ver producto</a>';
                  ...
                  echo "No hay productos en esta lista.";
              }
